...
json_check = {"a_data_init": {"Primary": {"WriteCount": 1, "ReadCount": 1, "Addr": "localhost:9500"}, 
	      ...
	      "b_data_fw": {"Primary": {"WriteCount": 10, "ReadCount": 11, "Addr": "localhost:9501"}, 
...
if "data" in path:
	...
	if data["Primary"] == json_check[check]["Primary"] and data["Replicas"] == json_check[check]["Replicas"]:
		print "pass"
	else:
		print "zkdata:", data["Primary"], data["Replicas"]
		print "checkdata:", json_check[check]
		print "fail"
